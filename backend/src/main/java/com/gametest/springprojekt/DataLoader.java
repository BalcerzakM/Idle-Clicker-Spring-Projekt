...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CharacterEntity character1 = new CharacterEntity(null,player, "test", characterClass,"avatar3.png",4,1000,420,67,67,67,67,10000,67, List.of(),List.of(), null, null, null);
